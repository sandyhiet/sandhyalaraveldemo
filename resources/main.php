...
<html lang="en">
  ...
  <body>
    ...
    @extends('layout.nav.nav')

    
	<!-- Hotel banner image -->
	
    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="hotel banner image" width="100%" height="400">
